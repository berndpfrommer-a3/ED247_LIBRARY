...
find_package(Git)
if(Git_FOUND)
  execute_process(COMMAND ${GIT_EXECUTABLE} -C ${CMAKE_SOURCE_DIR} describe --tags --always --dirty RESULT_VARIABLE STATUS OUTPUT_VARIABLE VERSION OUTPUT_STRIP_TRAILING_WHITESPACE)
